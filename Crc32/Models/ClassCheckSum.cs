...
namespace Crc32WpfApplication.Models {
    ...
    internal class Crc32Class {
        ...
        /// <summary>
        /// Polinomio espejo 0x4c11db7
        /// </summary>
        private const uint MirPolynom =  0xEDB88320U;

        /// <summary>
        /// Valor inicial de COP
        /// </summary>
        private const uint CrcInit = 0xFFFFFFFFU;

        /// <summary>
        /// el número con el que la operación XOR suma el COP antes de finalizar el cálculo
        /// </summary>
        private const uint CrcXor = 0xFFFFFFFFU;

        /// <summary>
        /// Tabla de cálculo CRC32
        /// </summary>
        ...
        /// <summary>
        /// Cálculo de la suma de comprobación CRC32
        /// </summary>
        ...
        /// <summary>
        /// CRC32 Cálculo inverso de suma de comprobación
        /// </summary>
        /// <param name="data"></param>
        /// <param name="count"></param>
        /// <param name="crc32"></param>
        ...
        /// <summary>
        ///Conversión a una matriz de enteros de 32 bits
        /// </summary>
        /// <param name="data"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Encontrar un elemento en una tabla
        /// </summary>
        ...
        private Tuple< uint, uint > Find( uint value ) {
            ...
            throw new ArgumentNullException("Valor no encontrado en la tabla");
        }
